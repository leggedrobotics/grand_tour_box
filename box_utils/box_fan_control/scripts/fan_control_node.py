...
class FanControlNode(object):
    def __init__(self):
        ...
        self.pi.set_PWM_dutycycle(FAN_GPIO, 0) # PWM off
        self.pi.set_PWM_dutycycle(FAN_GPIO, 255) # Full speed
        servers = {}
        ...
        servers["set_fan_speed"] = rospy.Service(f"~{m}", SetFanSpeed, self.set_fan_speed)
        rospy.loginfo(f"[FanControllerNode] Started in mode {self.mode} / Fan speed {self.desired_fan_speed_in_percentage}%.")
    ...
    def get_params(self):
        ...
        self.desired_fan_speed_in_percentage = rospy.get_param("~desired_fan_speed_in_percentage", 10)
    ...
    def set_fan_speed(self, request: SetFanSpeedRequest):
        ...
        self.desired_fan_speed_in_percentage = request.fan_speed_in_percentage
