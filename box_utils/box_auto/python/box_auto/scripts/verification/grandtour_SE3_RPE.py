...
def process_directory(base_path, output_dir, config, disable_viz, prefix):
    ...
    for param_set in config["bag_topic_pairs"]:
        ...
        ref_file = eval_params.get("ape_rpe")["reference_file"]
        ...
        run_rpe(test_name, reference_file, estimated_file, params, output_dir, disable_viz, "translation_part")
        run_rpe(test_name, reference_file, estimated_file, params, output_dir, disable_viz, "rotation_angle_deg")
