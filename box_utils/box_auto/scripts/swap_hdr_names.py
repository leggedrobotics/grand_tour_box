...
bags = [ (get_bag(MISSION_DATA, "*_jetson_hdr_front_raw_swap.bag"), get_bag(MISSION_DATA, "*_jetson_hdr_front_raw_swap.bag").replace("_hdr_front_raw_swap.bag", "_hdr_right_raw.bag"),  "hdr_front", "hdr_right"),
        (get_bag(MISSION_DATA, "*_jetson_hdr_right_raw_swap.bag"), get_bag(MISSION_DATA, "*_jetson_hdr_right_raw_swap.bag").replace("_hdr_right_raw_swap.bag", "_hdr_front_raw.bag"),  "hdr_right", "hdr_front")  
    ]
