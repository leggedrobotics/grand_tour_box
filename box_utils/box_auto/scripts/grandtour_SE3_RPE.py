...
def run_ate(args):  
    ...
    delta = 1.0 # in meters, this is the distance travelled.
    delta_unit = Unit.meters
    relation = PoseRelation.rotation_angle_deg # PoseRelation.translation_part #full_transformation
    ...
    result = main_rpe.rpe(traj_reference, traj_estimated, est_name=est_name,
