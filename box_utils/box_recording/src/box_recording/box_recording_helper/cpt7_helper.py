...
SIGNAL_TO_RECORD = [
    ...
    # "LOG FILE RANGECMP",
    # "LOG FILE RXSTATUSB",
    # "LOG FILE THISANTENNATYPEB",
    # # ALIGN
    "LOG FILE ALIGNBSLNENUB",
    "LOG FILE ALIGNBSLNXYZB",
    "LOG FILE ALIGNDOPB",
    # "LOG FILE BDSEPHEMERIS",
    # "LOG FILE BESTPOS",
    "LOG FILE DUALANTENNAHEADINGB ONNEW",
    ...
    # "LOG FILE RANGE",
    # "LOG FILE RXSTATUS",
    "LOG FILE TERRASTARINFOB ONNEW",
    "LOG FILE TERRASTARSTATUSB ONNEW",
    "LOG FILE TRACKSTATB ONNEW",
    # # TERRASTAR
    # "LOG FILE ALMANAC",
    # "LOG FILE BDSALMANAC",
    # "LOG FILE BDSBCNAV1EPHEMERIS",
    ...
    # "LOG FILE LBANDBEAMTABLE",
    # "LOG FILE LBANDTRACKSTAT",
    "LOG FILE PPPPOS ONNEW",
    "LOG FILE PPPSATS ONNEW",
    "LOG FILE PSRPOS ONNEW",
    # "LOG FILE QZSSALMANAC",
    # "LOG FILE QZSSEPHEMERIS",
    # "LOG FILE RANGE",
    # "LOG FILE RXSTATUS",
