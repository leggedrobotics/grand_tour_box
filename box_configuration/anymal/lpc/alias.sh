...
alias chrony_set_default="sudo killall chronyd; sudo rm -f /etc/chrony/chrony.conf; sudo ln -s/etc/chrony/chrony_robot.conf /etc/chrony/chrony.conf; sudo chronyd"
