...
alias l-autonomy='tmuxp load $(rospack find box_launch)/../tmux/opc_autonomy.yaml'
alias l-recording='tmuxp load $(rospack find box_launch)/../tmux/opc_recording.yaml'
